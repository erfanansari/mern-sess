...
// import BrandsJobs from "../BrandsJobs";
      ...
      <div className="Jobs">
        <Row xs="12">
          ...
          <Col
            ...
            lg={{ size: 9, order: 2 }}
          >
            <Row className="align-items-center mx-0 mb-4 mt-4 mt-lg-0 py-3 py-lg-0 bg-white Jobs-toolbar">
              <Col
                xs={{ size: 12, order: 1 }}
                sm={{ size: 12, order: 1 }}
                md={{ size: 5, order: 1 }}
            ...
            {/* <Switch>
              <Route exact path="/Jobs" component={ProductsJobs} />
              <Route path="/Jobs/category/:slug" component={CategoryJobs} />
              <Route path="/Jobs/brand/:slug" component={BrandsJobs} />
